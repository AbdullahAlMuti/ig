...
const SELECT_CLASS =
  'h-8 rounded-md border border-[#E6E8EC] bg-white px-2 text-[11px] font-medium text-[#171A21] transition-colors hover:border-[#D1D5DB] focus:border-[#6558E8] focus:outline-none focus:ring-1 focus:ring-[#6558E8] cursor-pointer shrink-0';
...
export function SortAndScrollToolbar({ store }: { store: MediaStoreApi }) {
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-2 border-b border-[#E6E8EC] bg-white px-3.5 py-2.5">
      {/* Sorter, Date Filter & Performance Badge Popover Filter */}
      ...
      <div className="flex items-center gap-1.5 shrink-0">
        ...
        <button
          ...
          className={`flex h-8 items-center justify-center gap-1.5 rounded-md px-2.5 text-[11px] font-medium transition-all active:scale-95 disabled:pointer-events-none ${
            scrolling
        ...
        <button
          ...
          disabled={disabled}
          className="flex h-8 items-center justify-center gap-1 rounded-md border border-[#E6E8EC] bg-white px-2 text-[11px] font-medium text-[#171A21] transition-all hover:bg-[#F4F5F7] active:scale-95 disabled:opacity-40 disabled:pointer-events-none"
        ...
        <button
          ...
          disabled={!scrolling}
          className={`flex h-8 items-center justify-center gap-1 rounded-md px-2 text-[11px] font-medium transition-all active:scale-95 ${
            scrolling
